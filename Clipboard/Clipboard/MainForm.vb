...
#Region "Net -> Js"
    ...
    Private Sub AddRecord()
        ...
        If iData IsNot Nothing Then
            For Each Item As (Format As String, Action As Action(Of IDataObject)) In ActionWithFormat
        ...
        Select Case Command
            ...
            Case CommandName.AddFile
                ...
                If fileOrfolder Then
                    If AddFolderDialog.ShowDialog() = DialogResult.OK Then
                        SendText = AddFolderDialog.SelectedPath
