...
Public Class VistaFolderBrowserDialog
    ...
    Private Const FileOpenDialogGuid As String = "DC1C5A9C-E88A-4dde-A5A1-60F82A20AEF7"
    Private Const IFileOpenDialogGuid As String = "42f85136-db7e-439c-85f1-e4075d135fc8"
    Private Const IShellItemGuid As String = "43826D1E-E718-42EE-BC55-A1E261C37BFE"
    ...
    <ComImport>
    <Guid(FileOpenDialogGuid)>
    Private Class FileOpenDialog
    End Class

    <ComImport>
    <Guid(IFileOpenDialogGuid)>
